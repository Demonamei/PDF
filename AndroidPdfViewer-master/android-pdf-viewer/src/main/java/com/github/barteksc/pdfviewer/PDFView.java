...
public class PDFView extends RelativeLayout {
    ...
    private float firstXoffset = -1;
    private float firstYoffsett = -1;
    public float getFirstXoffset() {
        return firstXoffset;
    }

    public void setFirstXoffset(float firstXoffset) {
        this.firstXoffset = firstXoffset;
    }

    public float getFirstYoffsett() {
        return firstYoffsett;
    }

    public void setFirstYoffsett(float firstYoffsett) {
        this.firstYoffsett = firstYoffsett;
    }
    ...
    public int findTopFocusPage(float xOffset, float yOffset) {
        float currOffset = swipeVertical ? yOffset : xOffset;
        float length = swipeVertical ? getHeight() : getWidth();
        // make sure first and last page can be found
        if (currOffset > -1) {
        ...
        return pdfFile.getPageAtOffset(-currOffset, zoom);
    }
